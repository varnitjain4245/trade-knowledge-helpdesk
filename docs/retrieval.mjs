...
/* The corpus is fetched rather than imported: an import assertion is a Node-ism, and
   this module has to run unchanged in a browser. */
const corpus = await fetch(new URL('./corpus.json', import.meta.url)).then(r => r.json());
